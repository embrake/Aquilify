...
SECRET_KEY = "aquilify-insecure-5o@=8%hI0E2kyelJYb@71%Hmz#@T04nPWtkWX9hAj$@%@c$" # replace with you own strong and secure secret key.
...
MIDDLEWARES = [
    ...
    {"origin": "aquilify.middlewares.TestConsoleAPI", "__init__": 'app'}
]
