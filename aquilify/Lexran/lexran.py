# under development -> Leran Dynamic html Framework @noql -> 3171

# do not use it in production -> 3172
...
class Lexran:
    def __init__(self, template_folder="views", cache_templates=True):
    ...
    def _render_conditionals(self, template):
        ...
        # Use a custom regex to handle the conditional with 'else'
    ...
    def _control_whitespace(self, template):
        # Implement whitespace control here (customize as needed)
    ...
    def add_custom_syntax(self, start_delimiter, end_delimiter):
        # Allow users to define custom syntax
