...
class TypedClass:
    ...
    def to_dict(self) -> typing.Dict[str, typing.Any]:
        """Converts the TypedClass instance to a dictionary."""
        return {attr: getattr(self, attr) for attr in self.__tc_options__["required_params"].keys()}

    def to_json(self, indent: int = 2) -> str:
        """Converts the TypedClass instance to a JSON string."""
        return json.dumps(self.to_dict(), indent=indent)

    @classmethod
    def from_dict(cls: type[TC], data: typing.Dict[str, typing.Any]) -> TC:
        """Creates a TypedClass instance from a dictionary."""
        return cls(**data)

    @classmethod
    def from_json(cls: type[TC], json_str: str) -> TC:
        """Creates a TypedClass instance from a JSON string."""
