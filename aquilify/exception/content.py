...
def exceptions(error_message: str, formatted_traceback: str, underlined_line: str, error_type: str, file_and_line: str):
    content = f"""
<html>
<head>
...
<p style="color: red; font-size: smaller; font-family: 'Courier New', monospace; text-align: left; margin: 10px 0; word-wrap: break-word;"><u style="color: red;">{file_and_line}</u></p>
        ...
        <p class="message-tool" style="text-align: right; color: #708090;">Powered  by <b>Evelax</b>, your friendly <b>Aquilify</b> powered traceback interpreter. </p> <br>
    </div>
</body>
</html>
"""
