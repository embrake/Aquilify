...
class Entity:
    ...
    def __init__(self, table_: Type[TableT], database: Sqlite3, auto_create: bool = False):
        """
    ...
    def set(self, data: dict[ColumnT, ColumnT.type.decoded_type]):
        """
        ...
        if self.database.auto_execute:
            return Set(self, data).execute()
        
        return Set(self, data)

    def insert(self, data: dict[ColumnT, ColumnT.type.decoded_type]):
        """
        ...
        if self.database.auto_execute:
            return InsertInto(self, data).execute()
        
        return InsertInto(self, data)

    def select(self, *columns: Column | Literal[Wildcards.All], distinct: bool = False):
        """
    ...
    def drop(self) -> typing.Union[DropTable, Result]:
        """
