...
class Template:
    ...
    def __init__(self, template_string, template_id="UNIDENTIFIED"):
        self.root_node = xenarx.compiler.compile(template_string, template_id)
    ...
    def _render(self, context):
        ...
        if self.root_node.children and isinstance(self.root_node.children[0], ExtendsNode):
            if xenarx.loader:
                parent_template = xenarx.loader(self.root_node.children[0].parent_name)
                ...
                raise xenarx.errors.TemplateLoadError(msg)
        else:
